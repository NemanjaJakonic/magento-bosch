...
class Cybage_Megamenu_Adminhtml_MegamenuController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function saveAction() 
    {
        ...
        if ($data = $this->getRequest()->getPost()) {
            if(!empty($data['type_id'])  && intval($data['type_id']) && !empty($data['template_id']) && intval($data['template_id']))
            {
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('megamenu/items');
    }
}